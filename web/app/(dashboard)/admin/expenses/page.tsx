...
import { Check, X, Receipt, ChevronLeft, ChevronRight, Search } from 'lucide-react'
...
import { useApproveExpense, useExpenses, useRejectExpense } from '@/hooks/use-expenses'
...
export default function AdminExpensesPage() {
  ...
  return (
    <DashboardLayout title="Expense Approvals" allowedRoles={['admin', 'hr']}>
