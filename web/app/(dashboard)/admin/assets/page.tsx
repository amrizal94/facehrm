...
import type { Asset, AssetAssignment, AssetCategory, AssetCondition, AssetFilters, AssetStatus } from '@/types/asset'
                ...
                <TableRow key={a.id} className="hover:bg-muted/30">
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <Button size="sm" variant="ghost" className="h-7 w-7 p-0 text-destructive hover:text-destructive" onClick={() => openDelete(a)} title="Hapus">
