...
const NAV_ITEMS: NavItem[] = [
  { label: 'Dashboard',   href: '/admin',            icon: LayoutDashboard, roles: ['admin', 'director'] },
  ...
  { label: 'Employees',   href: '/admin/employees',  icon: Users,           roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'Attendance',  href: '/admin/attendance', icon: Clock,           roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'My Attendance', href: '/staff/attendance', icon: Clock,         roles: ['staff'] },
  { label: 'Leave',       href: '/admin/leave',      icon: CalendarDays,    roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'My Leave',    href: '/staff/leave',      icon: CalendarDays,    roles: ['staff'] },
  { label: 'Overtime',    href: '/admin/overtime',   icon: Timer,           roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'My Overtime', href: '/staff/overtime',   icon: Timer,           roles: ['staff'] },
  { label: 'Holidays',    href: '/admin/holidays',   icon: CalendarDays,    roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'Payroll',     href: '/admin/payroll',    icon: Receipt,         roles: ['admin', 'hr', 'director'] },
  { label: 'My Payslip',  href: '/staff/payslip',    icon: Receipt,         roles: ['staff'] },
  { label: 'Face Data',   href: '/admin/face',       icon: ScanFace,        roles: ['admin', 'hr', 'manager', 'director'] },
  { label: 'Reports',     href: '/admin/reports',    icon: BarChart3,       roles: ['admin', 'hr', 'manager', 'director'] },
  ...
  { label: 'My Profile',   href: '/staff/profile',    icon: UserCircle,      roles: ['staff', 'hr', 'admin', 'manager', 'director'] },
  { label: 'Notifications', href: '/notifications',   icon: Bell,            roles: ['admin', 'hr', 'staff', 'manager', 'director'] },
]
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          ...
          const isActive = item.href === '/admin' || item.href === '/hr' || item.href === '/staff' || item.href === '/manager' || item.href === '/director'
            ? pathname === item.href
